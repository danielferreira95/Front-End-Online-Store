...
function ProductDetails() {
  ...
  return (
    <div>
      ...
      <button data-testid="product-detail-add-to-cart" onClick={ () => handleAddToCard({ price: state.product.price, thumbnail: state.product.thumbnail, title: state.product.title }) }>Adicionar produto ao carrinho</button>
      <Link to="/cart">
